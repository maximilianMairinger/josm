...
Josm is an (**J**S) **o**bject-oriented **s**tate **m**anager for the web & node, which aims to be both, a lightweight observable (called Data) implementation & a feature rich state manager, providing an awesome development experience.

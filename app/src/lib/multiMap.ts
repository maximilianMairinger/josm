// pulled from https://github.com/Mafalda-SFU/multi-map/blob/08f018c637bd1261558fecaf3998e099298dca14/index.js
...
Multimap.prototype.entries = function() {
  ...
  return {
    ...
    next: function(){
      ...
      return {
        value: [next.value, self.get(next.value)],
        done: false
      };
    }
  };
...
type MultiMapConstructor = new<K, V> (iterable?: Iterable<[any, any]>) => MultiMap<K, V>;
export const MultiMap = Multimap as any as MultiMapConstructor;
export type MultiMap<K, V> = Omit<Map<K, V>, "get"> & {get(e: K): V[]}
